...
public class Main {
    ...
    private static Scanner sc = new Scanner(System.in); //scanner untuk input
    ...
    private static void showLoginMenu() {
        ...
        for (int i = 0; i < listUser.size(); i++) {
             ...
             * dengan username yang sudah diinput.
             * Jika ada ganti userIndex dengan Index dari User Tersebut, kemudian hentikan
             * perulangan
             */
           if (listUser.get(i).getUsername().equals(username)){ //equels membandingkan 2 string
                userIndex = i; //supaya ditau di dalam list userindex  mana yg sama dengan yg sdh diinput
                break;
            }
            }
